...
abstract class ContinentCollection {
  ...
  static Future<void> initCountryListIntoContinents(BuildContext context) async {
    var jsonData = json.decode(await DefaultAssetBundle.of(context).loadString(Constants.j_country_data));
    ...
    for(var data in documents) {
      ...
      // else
      getContinentByCode(data['*']).addCountryCode(data['Two_Letter_Country_Code']);
  ...
  static Continent getContinentByCode(String code) {
    ...
    return getContinents().firstWhere((element) => element.code == code, orElse: () => null);
  }
